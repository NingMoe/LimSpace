...
public class RedisService {
	...
	public synchronized String getData(String sessionId) {
		Jedis jedis = null;
		String res = null;
		try {
			initPool();
			jedis = pool.getResource();
			res = jedis.get(USER_PRENAME + sessionId);
		} catch (Exception e) {
			res = null;
			e.printStackTrace();
			logger.error(e);
	...
	public synchronized boolean setData(String sessionId, String value, int expireSeconds) {
		Jedis jedis = null;
		String key = USER_PRENAME + sessionId;
		boolean ret = false;
		try {
			initPool();
			jedis = pool.getResource();
