...
public interface OrderOperationDao {
	 ...
	 * @return
	 */
	int applyToCancel(@Param("orderId") Integer orderId, @Param("custId") Integer custId, @Param("no") String no, @Param("reason") String reason);
	 ...
	 * @return
	 */
	int applyToReturn(@Param("orderId") Integer orderId, @Param("custId") Integer custId, @Param("no") String no,@Param("reason") String reason,@Param("reasonType") Integer reasonType,@Param("pics") String pics);
	...
	OrderCancellation getOrderCancellationByOrderId(@Param("orderId") Integer orderId);
	
	
	void updateByPrimaryKeySelective(OrderCancellation orderCancellation);

	Integer selectRefundByOrderId(Integer id);
	void insertCancellation(OrderCancellation orderCancellation);

	void insertRefund(@Param("orderId") Integer orderId,@Param("amount") BigDecimal amount,@Param("cancellationId") Integer cancellationId);
